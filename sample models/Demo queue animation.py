...
sim.AnimateText(
    text=lambda: q.length.print_histogram(as_str=True), x=500, y=700, text_anchor="nw", font="narrow", fontsize=10
)

sim.AnimateText(text=lambda: q.print_info(as_str=True), x=500, y=340, text_anchor="nw", font="narrow", fontsize=10)
