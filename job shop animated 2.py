...
def animation_pre_tick(self, t):
    for i, job in enumerate(plant):
        ...
        for task in job.tasks:
            ...
            task.an_bar.update(rectangle0=(0, 0, len, 12), x0=x, y0=y, fillcolor0=color, linecolor0='white')
            x += len
...
class Job(sim.Component):
    def setup(self, job_generator):
        ...
        self.an_execute_bar = sim.Animate(x0=100, rectangle0=(0, 0, 70, 12), linewidth0=0)
        self.an_execute_text = sim.Animate(x0=100, text='', fontsize0=12, anchor='sw', textcolor0='white', offsetx0=2, offsety0=1)
