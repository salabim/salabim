...
if Path("Upward Systems logo horizontal reverse.gif").is_file():
    ...
    sim.can_animate()
    sim.Animate(image=env.salabim_logo(), x0=50, y0=env.height() - 49, width0=150, anchor="nw", screen_coordinates=True)
...
colors = "red orange orangered tomato coral crimson indianred".split()
